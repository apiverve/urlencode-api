...
namespace APIVerve.API.URLEncoderDecoder
{
    ...
    /// <summary>
    /// Client for the URLEncoderDecoder API
    /// </summary>
    public class URLEncoderDecoderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/urlencode";
        ...
        public URLEncoderDecoderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public URLEncoderDecoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public URLEncoderDecoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, URLEncoderDecoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(URLEncoderDecoderQueryOptions options)
        {
        ...
        public ResponseObj Execute(URLEncoderDecoderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(URLEncoderDecoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(URLEncoderDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(URLEncoderDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(URLEncoderDecoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(URLEncoderDecoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(URLEncoderDecoderQueryOptions options)
        {
