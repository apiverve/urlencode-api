...
{
    class URLEncoder/DecoderExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/urlencode";

        /// <summary>
        /// Make a POST request to the URL Encoder/Decoder API
        /// </summary>
        static async Task<JsonDocument> CallURLEncoder/DecoderAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { text &#x3D; &quot;Hello World &amp; Goodbye&quot;, action &#x3D; &quot;encode&quot; };
        ...
        {
            Console.WriteLine("📤 Calling URL Encoder/Decoder API...\n");

            var result = await CallURLEncoder/DecoderAPI();
