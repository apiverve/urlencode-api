# URL Encoder/Decoder API - Examples

This folder contains example code for using the URL Encoder/Decoder API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/urlencode',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/urlencode");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/urlencode](https://docs.apiverve.com/ref/urlencode)
