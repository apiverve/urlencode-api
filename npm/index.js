...
class urlencodeWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/urlencode');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/urlencode';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"action":{"type":"string","required":false,"default":"encode"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/urlencode`);
        }
    }
...
module.exports = urlencodeWrapper;
