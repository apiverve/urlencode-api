...
//
//     URLEncoderDecoderData data = Converter.fromJsonString(jsonString);

package com.apiverve.urlencode.data;
...
public class Converter {
    ...
    public static URLEncoderDecoderData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(URLEncoderDecoderData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(URLEncoderDecoderData.class);
        writer = mapper.writerFor(URLEncoderDecoderData.class);
    }
