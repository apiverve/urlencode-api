# URL Encoder/Decoder Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:urlencode-api:1.1.12'
}
```
...
```java
import com.apiverve.urlencode.URLEncoder/DecoderAPIClient;
import com.apiverve.urlencode.APIResponse;
import com.apiverve.urlencode.APIException;

// Initialize the client
URLEncoder/DecoderAPIClient client = new URLEncoder/DecoderAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/urlencode](https://docs.apiverve.com/ref/urlencode)
...
- **Documentation:** [https://docs.apiverve.com/ref/urlencode](https://docs.apiverve.com/ref/urlencode)
- **Issues:** [GitHub Issues](https://github.com/apiverve/urlencode-api/issues)
