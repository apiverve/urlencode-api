// Package urlencode provides a Go client for the URL Encoder/Decoder API.
//
// For more information, visit: https://apiverve.com/marketplace/urlencode?utm_source=go&utm_medium=readme
package urlencode
...
const (
	baseURL        = "https://api.apiverve.com/v1/urlencode"
	defaultTimeout = 30 * time.Second
)

// Client is the URL Encoder/Decoder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new URL Encoder/Decoder API client.
...
// Execute makes a request to the URL Encoder/Decoder API with typed parameters.
//
...
//   - text (required): string - The text to encode
